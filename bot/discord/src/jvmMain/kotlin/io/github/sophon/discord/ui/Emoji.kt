...
internal enum class Emoji(val id: String) {
    ...
    CHANNEL("<:channel:1494037989544694022>"),
    CHARGE("<:channel:1494037989544694022>"),
    CAST_RANGE("<:cast_range:1494037988366356581>"),
    ...
    DURATION("<:duration:1494038533109710950>"),
    ...
    RADIUS("<:radius:1494037990593269881>"),
